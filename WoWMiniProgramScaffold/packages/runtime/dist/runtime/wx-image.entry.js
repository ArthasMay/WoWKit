...
const WxImage = class {
  ...
  render() {
    const classList = modes.reduce((p, c) => ((p[c] = same(this.mode, c)), p), {});
    return (h(Host, null, h("img", { class: Object.assign({ image: true }, classList), src: this.src })));
  }
