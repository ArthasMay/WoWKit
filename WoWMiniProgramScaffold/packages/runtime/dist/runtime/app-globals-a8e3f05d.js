import { l as log, i as invokeNative } from "./utils-5f2205f9.js";
...
var vue = createCommonjsModule(function(module, exports) {
  ...
  (function(global, factory) {
    "object" === "object" && "object" !== "undefined"
      ...
      : typeof undefined === "function" && undefined.amd
      ? undefined(factory)
...
const Vue = /*@__PURE__*/ getDefaultExportFromCjs(vue);
...
function appGlobalScript() {
  ...
  def(window, "__setData", function(values) {
    log(values);
    Reflect.ownKeys(values).forEach(key => {
      vm[key] = values[key];
    });
  });
  invokeNative(1 /* lifeCycle */, "ready");
  window.onerror = function(e) {
    document.write(`<h1>${String(e)}</h1><p>${e.stack}</p>`);
  };
}
