  ...
  if (BUILD.vdomText && newVNode.$text$ !== null) {
    ...
    elm = newVNode.$elm$ = BUILD.svg
      ? doc.createElementNS(
          ...
          BUILD.slotRelocation && newVNode.$flags$ & 2 /* isSlotFallback */
            ? "slot-fb"
            : newVNode.$tag$
        )
      : doc.createElement(
        ...
        Object.defineProperty(prototype, memberName, {
          ...
          set(newValue) {
            if (
              ...
              (memberFlags & (31 /* Prop */ | 1024)) /* Mutable */ ===
                31 /* Prop */
            ) {
              consoleDevWarn(
...
const initializeComponent = async (
  ...
  if (
    ...
    if (BUILD.lazyLoad || BUILD.hydrateClientSide) {
      ...
      hostRef.$flags$ |=
        128 /* isWatchReady */ | 32 /* hasInitializedComponent */;
    }
    if (BUILD.style && Cstr.style) {
      ...
      if (!styles.has(scopeId)) {
        ...
        if (
          ...
          style = await import("./shadow-css-4cf364f5.js").then(m =>
